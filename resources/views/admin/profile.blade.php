            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 text-center pt-3">
                    <img src="@if ($user->karyawan->foto) {{ asset('storage/images/karyawan/' . $user->karyawan->foto) }}
                        ...
                        alt="" width="250px" class="rounded-circle img-thumbnail mb-3 img-fluid">
                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 text-start d-none" id="update">
                            <label for="formFile" class="form-label">Update Foto</label>
                            <img src="@if ($user->karyawan->foto == null)
                                                {{ asset('images/karyawan/'.$user->karyawan->foto) }}
                                                @endif" class="img-preview mb-3 rounded-circle img-thumbnail" alt="{{ $user->karyawan->nama_karyawan }}" height="200px"
                              height="250px">
